...
try {
    ...
    $inboxCount = $pdo->query("SELECT COUNT(*) FROM emails WHERE folder = 'inbox'")->fetchColumn();
    $starredCount = $pdo->query("SELECT COUNT(*) FROM emails WHERE is_starred = 1")->fetchColumn() ?: 0;
    $sentCount = $pdo->query("SELECT COUNT(*) FROM emails WHERE folder = 'sent'")->fetchColumn();
    $attachmentsCount = $pdo->query("SELECT COUNT(*) FROM emails WHERE attachments_count > 0")->fetchColumn();
